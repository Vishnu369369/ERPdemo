          ...
          <table cellSpacing="0" cellPadding="0">
            <thead style={{ border: "1px solid" }}>
              <tr>
                ...
                <th>
                  <span className="heading">PO Update Date</span>
                </th>
                <th>
                  <span className="heading">PO Type</span>
                </th>
                <th>
                ...
                <th>
                  <span className="heading">Bid No</span>
                </th>
                <th>
                  <span className="heading">Customer/Vendor Name</span>
                </th>
                <th>
                  <span className="heading">Tendor No</span>
                </th>
